...
public class MD5Utils {
    ...
    public static String getEncryptedPwd(String password) throws Exception {
        try {
            ...
            System.out.println("random salt:" + new String(salt));
...
//        System.out.println(new String(encrypte("63e2438edebb4d2c940942b129e605a2".getBytes(), "hai-cpt"), "utf-8"));

        System.out.println(getEncryptedPwd("hai-cpt"));
    }
}