...
import com.hai.common.cache.RedisBigMap;
...
public class BasicRedisClient {
     ...
     * @return
     */
    public boolean updateExp(final String key, Long expireTime) {
        if (exists(key)) {
    ...
    public Long removeField(String key, String... fields) {
        Long cnt = 0L;
    ...
    public Long removeField(String key, String field) {
