...
public enum MongoDBUtil {
    ...
    {
        //解析 XML
        FileBasedConfigurationBuilder<XMLConfiguration> xmlConfigurationFileBasedConfigurationBuilder =
                new FileBasedConfigurationBuilder<>(XMLConfiguration.class)
                        .configure(
                                /*new XMLBuilderParametersImpl().setFile(new File("properties/mongodb.properties"))*/
                                new XMLBuilderParametersImpl().setFile(new File(""))
                        );
    }

    static {
        System.out.println("===============MongoDBUtil初始化========================");
//        FileLocator.FileLocatorBuilder fileLocatorBuilder = FileLocatorUtils.fileLocator()
//                .basePath("/properties")
//                /*.fileName("properties/mongodb.properties")*/
//                .fileName("mongodb.properties");
//        FileLocator fileLocator = new FileLocator(fileLocatorBuilder);
//
//        PropertiesConfiguration propertiesConfiguration = new PropertiesConfiguration();
//        propertiesConfiguration.initFileLocator(fileLocator);
        ...
        try {
            propertiesConfiguration = configurations.properties(MongoDBUtil.class.getClassLoader().getResource("properties/mongodb.properties"));
        ...
        // 从配置文件中获取属性值
        String ip = compositeConfiguration.getString("database.host");
        int port = compositeConfiguration.getInt("database.port");

        System.out.println("ip: " + ip + ";\tport: " + port);
        instance.mongoClient = new MongoClient(ip, port);

        //properties variable test
        System.out.println("\n\njava.home:\t\t\t\t" + compositeConfiguration.getString("java.home"));
        System.out.println("application.home:\t\t" + compositeConfiguration.getString("application.name"));
