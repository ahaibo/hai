package com.hai.desinpattern.structure.flyweight;
...
public class ConcreteCompositeFlyweight implements Flyweight {
    ...
    private Map<Character, Flyweight> container = new HashMap<Character, Flyweight>();

    /**
     * 增加一个新的单纯享元对象到聚集中
     */
    public void add(Character key, Flyweight fly) {
        container.put(key, fly);
    }
    ...
    public Map<Character, Flyweight> getContainer() {
        return container;
    }
}