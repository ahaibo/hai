 ...
 * 动态代理
 */
package com.hai.javase.desinpattern.proxy;
...
class MyAOPImpl implements IMyAOP {
     ...
     * (non-Javadoc)
     *
     * @see com.hai.hai.javase.desinpattern.proxy.IMyAOP#before()
     */
    @Override
    public void before() {
     ...
     * (non-Javadoc)
     *
     * @see com.hai.hai.javase.desinpattern.proxy.IMyAOP#after()
     */
    @Override
    public void after() {
