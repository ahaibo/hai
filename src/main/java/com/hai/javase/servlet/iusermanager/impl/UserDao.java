 ...
 *
 */
package com.hai.javase.servlet.iusermanager.impl;

import com.hai.common.db.DBUtil;
import com.hai.javase.servlet.iusermanager.dao.IUserService;
...
public class UserDao implements IUserService {
     ...
     *
     * @see
     * com.hai.hai.javase.servlet.iusermanager.dao.IUserService#deleteUserById(int)
     */
    @Override
     ...
     *
     * @see
     * com.hai.hai.javase.servlet.iusermanager.dao.IUserService#getAllUsers(java.lang
     ...
     * (non-Javadoc)
     *
     * @see com.hai.hai.javase.servlet.iusermanager.dao.IUserService#getUserById(int)
     */
    @Override
